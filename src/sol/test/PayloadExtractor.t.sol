...
contract PayloadExtractorTest is Test {
    ...
    bytes constant PAYLOAD =
        hex"1d3981b4c1f92b6633fc5acd8e02aa4859240122f1a1f1c40ed847c8bf2e69470aa0d56f087ee2efa5fcfaf5d125ae1deaa8fd02ee6e0678563412efcdab9078563412efcdab9078563412000000000000000000000000000000000000000000";
    ...
    function test_ParseFullPayload() public {
        ...
        assertEq(
            parsed.txId, 0x1d3981b4c1f92b6633fc5acd8e02aa4859240122f1a1f1c40ed847c8bf2e6947, "Transaction ID mismatch"
        );

        // Verify address from field 5 (reversed back to original)
        assertEq(parsed.addressField5, 0x02fda8ea1daE25d1F5FaFCA5Efe27E086Fd5a00A, "Address field 5 mismatch");
        ...
        assertEq(parsed.addressField7, 0x1234567890AbcdEF1234567890aBcdef12345678, "Test address mismatch");
    }

    function test_ExtractTestAddress() public {
        address testAddr = extractor.extractTestAddress(PAYLOAD);

        assertEq(testAddr, 0x1234567890AbcdEF1234567890aBcdef12345678, "Extracted test address should match original");
    }
    ...
    function test_ExtractRecipientAddress() public {
        ...
        assertEq(
            recipient, 0x02fda8ea1daE25d1F5FaFCA5Efe27E086Fd5a00A, "Extracted recipient address should match original"
        );
    }
    ...
    function test_ByteReversal() public {
        ...
        assertEq(address(original), 0x1234567890AbcdEF1234567890aBcdef12345678, "Byte reversal failed");
    }
